...
if __name__ == '__main__':  #straight away go to this
    ...
    #inception_pred.compile(optimizer = tf.keras.optimizers.RMSprop(learning_rate=0.0002), loss=tf.keras.losses.CategoricalCrossentropy(from_logits = False) , metrics=['accuracy'])
        ...
        my_plots("/home/pranab_2021cs25/S_Sharma/4_CLASS_CLASSIFICATION_WITH_TB_RESULTS/",history,"DenseNet201_4_class_with_segmentation")
        filename = '/home/pranab_2021cs25/S_Sharma/4_CLASS_CLASSIFICATION_WITH_TB_RESULTS/DenseNet201_model_4_class_with_segmentation.sav'
        np.save('/home/pranab_2021cs25/S_Sharma/4_CLASS_CLASSIFICATION_WITH_TB_RESULTS/DenseNet201_model_4_class_with_segmentation.npy',history.history)
        ...
        my_plots("/home/pranab_2021cs25/S_Sharma/4_CLASS_CLASSIFICATION_WITH_TB_RESULTS/",history,"SE_INCEPTION_V3_4_class_with_segmentation") #PLOTTING THE ACCURACY AND LOSS CURVE

        filename = '/home/pranab_2021cs25/S_Sharma/4_CLASS_CLASSIFICATION_WITH_TB_RESULTS/SE_INCEPTION_V3_MODEL_4_class_with_segmentation.sav'
        np.save('/home/pranab_2021cs25/S_Sharma/4_CLASS_CLASSIFICATION_WITH_TB_RESULTS/SE_INCEPTION_V3_MODEL_4_class_with_segmentation.npy',history.history)
        ...
        my_plots("/home/pranab_2021cs25/S_Sharma/4_CLASS_CLASSIFICATION_WITH_TB_RESULTS/",history,"se_squeeznet_4_class_with_segmentation") #plotting the accuracy and loss curve

        filename = '/home/pranab_2021cs25/S_Sharma/4_CLASS_CLASSIFICATION_WITH_TB_RESULTS/se_squeeznet_MODEL_4_class_with_segmentation.sav' #file name with which model is saved
        np.save('/home/pranab_2021cs25/S_Sharma/4_CLASS_CLASSIFICATION_WITH_TB_RESULTS/se_squeeznet_MODEL_4_class_with_segmentation.npy',history.history)
