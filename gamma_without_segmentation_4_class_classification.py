...
model_name=int(input("Which model you would like to train(TYPE THE NUMBER ONLY LIKE 1,2,3)? 1. Densenet 201    2. SE Inception v3   3. SE SQUEEZNET"))
import glob
import pickle
import tensorflow as tf
import argparse
...
if __name__ == '__main__':  #straight away go to this
    ...
    if model_name==1:  #IT WILL RUN DENSENET 201 MODEL
        ...
        my_plots("/home/sriparna/s_sharma/Gama based/4_CLASS_CLASSIFICATION_WITH_TB_RESULTS/",history,"DenseNet201_4_class")
        filename = '/home/sriparna/s_sharma/Gama based/4_CLASS_CLASSIFICATION_WITH_TB_RESULTS/DenseNet201_model_4_class.sav'
        np.save('/home/sriparna/s_sharma/Gama based/4_CLASS_CLASSIFICATION_WITH_TB_RESULTS/DenseNet201_model_4_class.npy',history.history)
        ...
        Model = SEInception(length, width, num_channel, model_width, ratio=reduction_ratio, problem_type=problem_type, output_nums=output_nums,
                          pooling='avg', dropout_rate=False, auxilliary_outputs=False).SEInception_v3()
        ...
        my_plots("/home/sriparna/s_sharma/Gama based/4_CLASS_CLASSIFICATION_WITH_TB_RESULTS/",history,"SE_INCEPTION_V3_4_class") #PLOTTING THE ACCURACY AND LOSS CURVE

        filename = '/home/sriparna/s_sharma/Gama based/4_CLASS_CLASSIFICATION_WITH_TB_RESULTS/SE_INCEPTION_V3_MODEL_4_class.sav'
        np.save('/home/sriparna/s_sharma/Gama based/4_CLASS_CLASSIFICATION_WITH_TB_RESULTS/SE_INCEPTION_V3_MODEL_4_class.npy',history.history)
        pickle.dump(Model, open(filename, 'wb')) #SAVING THE MODEL
    
    elif model_name==3: #IT WILL RUN SE SQUEEZENET 
        ...
        my_plots("/home/sriparna/s_sharma/Gama based/4_CLASS_CLASSIFICATION_WITH_TB_RESULTS/",history,"se_squeeznet_4_class") #plotting the accuracy and loss curve

        filename = '/home/sriparna/s_sharma/Gama based/4_CLASS_CLASSIFICATION_WITH_TB_RESULTS/se_squeeznet_MODEL_4_class.sav' #file name with which model is saved
        np.save('/home/sriparna/s_sharma/Gama based/4_CLASS_CLASSIFICATION_WITH_TB_RESULTS/se_squeeznet_MODEL_4_class.npy',history.history)
